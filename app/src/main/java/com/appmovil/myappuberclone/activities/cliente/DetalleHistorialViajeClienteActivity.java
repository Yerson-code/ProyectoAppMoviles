...
public class DetalleHistorialViajeClienteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle_historial_viaje_cliente);
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            if (dataSnapshot.exists()) {
                                ...
                                if (dataSnapshot.hasChild("image")) {
                                    ...
                                    Picasso.with(DetalleHistorialViajeClienteActivity.this).load(image).into(mCircleImage);
                                }
                            }
                        }
