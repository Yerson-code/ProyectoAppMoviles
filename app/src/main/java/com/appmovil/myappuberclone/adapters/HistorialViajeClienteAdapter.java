...
import com.appmovil.myappuberclone.activities.cliente.DetalleHistorialViajeClienteActivity;
...
public class HistorialViajeClienteAdapter extends FirebaseRecyclerAdapter<HistoryBooking, HistorialViajeClienteAdapter.ViewHolder> {

    private ConductorProvider mConductorProvider;
    private Context mContext;

    public HistorialViajeClienteAdapter(FirebaseRecyclerOptions<HistoryBooking> options, Context context) {
        super(options);
    ...
    protected void onBindViewHolder(@NonNull final ViewHolder holder, int position, @NonNull HistoryBooking historyBooking) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(mContext, DetalleHistorialViajeClienteActivity.class);
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new HistorialViajeClienteAdapter.ViewHolder(view);
