package com.appmovil.myappuberclone.servicios;
...
import com.appmovil.myappuberclone.activities.conductor.NotificacionLlamadaActivity;
import com.appmovil.myappuberclone.channel.NotificationHelper;
...
public class MyFirebaseMessagingClient extends FirebaseMessagingService {
    ...
    private void showNotificationActivity(String idClient, String origin, String destination, String min, String distance) {
        ...
        Intent intent = new Intent(getBaseContext(), NotificacionLlamadaActivity.class);
