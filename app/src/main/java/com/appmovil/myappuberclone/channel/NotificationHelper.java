package com.appmovil.myappuberclone.channel;
...
public class NotificationHelper extends ContextWrapper {
    private static final String CHANNEL_ID = "com.appmovil.myappuberclone";
    private static final String CHANNEL_NAME = "MyAppUberClone";
